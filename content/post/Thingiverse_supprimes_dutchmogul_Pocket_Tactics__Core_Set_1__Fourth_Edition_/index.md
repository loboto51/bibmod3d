...
---
title: "[GRATUIT] Thingiverse_supprimes > dutchmogul > Pocket_Tactics__Core_Set_1__Fourth_Edition_ [non dl]"
...
Source : [https://www.thingiverse.com/thing:1820557](https://www.thingiverse.com/thing:1820557)
...
~~~
Though playable with other outdated sets from this edition, this set is not compatible with the current edition of Pocket-Tactics. You can find all of the [current sets here on our site](https://www.illgottengames.net/products?category=Pocket-Tactics).

If you want to help us create more sets and expansions for the game (and get a bunch of 3d printables in the process) please consider supporting us on [Patreon](https://www.patreon.com/illgottengames)!

-------------------------------------------------RULES-------------------------------------------------------
For a standard core set, you'll want to print the following: 
Conscript x1, Spearman x1, Archer x1, Swordsman x1, Shieldmaiden x1, Highcourt Mage x1, Darkwood Stalker x1, Darkwood Marauder x1, Darkwood Juggernaut x1, Forest Witch x1, Cursed Ranger x1, Druid x1, Plains tiles x9, Water tiles x3, Forest x1, Highland x1, Village x1

In addition, each player will need six dice (three red, and three blue).

Inverted-color images of the rules cards are available [here](http://i.imgur.com/xnyNU3o.png), [here](http://i.imgur.com/1D7yCJb.png). and [here](http://i.imgur.com/l4A6awp.png) if you want something a little less ink-intensive.
