...
---
title: "[GRATUIT] Cults3d_supprimes_stl > IamAlpharius > Tiny_tanks__Tiny_FireRaptor_and_StormEagle_Gunships_for_8mm_games___scooped_and_supported [dl]"
...
- "volants SMI"
- "epic volants SMI"
- "Sm-stormeagles-fireraptors"
- "epic Sm-stormeagles-fireraptors"
- "volants Sm-stormeagles-fireraptors"
- "epic volants Sm-stormeagles-fireraptors"
...
Source : [https://cults3d.com/en/3d-model/game/tiny-tanks-tiny-fireraptor-and-stormeagle-gunships-for-8mm-games-scooped-and](https://cults3d.com/en/3d-model/game/tiny-tanks-tiny-fireraptor-and-stormeagle-gunships-for-8mm-games-scooped-and)

Id objet : tiny-tanks-tiny-fireraptor-and-stormeagle-gunships-for-8mm-games-scooped-and
...
I removed the lower floor of the model, so the magent insert is on the roof of the model and can accept magnets up to 10mm - so pick your poison.

I also did some editing to make sure there were no resin captures.  

These models are not hollowed in the traditional sense - no resin can be captured and all internals can be exposed to UV light for curing.  Some idiot will not look at the files and mis-understand that and will invariably do an "aktuallly blah blah blah" - it always seems to happen....
~~~
