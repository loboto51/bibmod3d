...
---
title: "[PAYANT] Cults3d > imitationoflife > Brother_Luminouz__Nuclear_Cultist_with_Heavy_Weapons [non dl]"
date: "2024-11-10T21:07:09Z"
toc: true
image: "thumbs_-_brother-luminouz-nuclear-cultist-with-heavy-weapons_-_Images_1.jpg"
tags:
- "imitationoflife"
- "15mm"
- "28mm"
...
![](<thumbs_-_brother-luminouz-nuclear-cultist-with-heavy-weapons_-_Images_1.jpg> "thumbs_-_brother-luminouz-nuclear-cultist-with-heavy-weapons_-_Images_1.jpg")

  

Source : [https://cults3d.com/en/3d-model/game/brother-luminouz-nuclear-cultist-with-heavy-weapons](https://cults3d.com/en/3d-model/game/brother-luminouz-nuclear-cultist-with-heavy-weapons)

Id objet : brother-luminouz-nuclear-cultist-with-heavy-weapons
...
~~~
He´s really into radioactive salvation. And big weapons!
...
Terms and agreements for the
use of IOL Minis printable STL files:

Please observe the following licence agreement regarding the use of the printable files, as well as any physical
printed items. If you cannot accept these terms, do not proceed to use these files.

When purchasing these files, you are granted a limited personal use license, allowing you to use the files for 3D printing for strictly personal, non-transferable, non-commercial purposes. You are not permitted to share the files with any third parties, including using 3D print service companies or individuals and friends offering such services. The digital assets cannot be used for any purposes beyond the intended use of private 3D printing, including using the assets or associated images for AI training.

You ARE allowed to use the files for digitally kitbashing your miniatures, as long as the converted miniatures are used within the framework of the licencing terms. ( so no sharing, gifting or selling of digital assets or physical models).

Do not sell, share, gift, transmit or redistribute any files or printed miniatures, in their original or
modified form, without the express permission of Imitation of Life Studio.

Failure to uphold these terms
will be considered infringement of copyright, and will be pursued legally.

IOL Minis is the property of Imitation of Life Studio and Sonny Bundgaard, and any designs remain
