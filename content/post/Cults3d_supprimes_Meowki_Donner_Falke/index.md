...
---
title: "[PAYANT] Cults3d_supprimes > Meowki > Donner_Falke [non dl]"
...
Source : [https://cults3d.com/en/3d-model/game/donner-falke](https://cults3d.com/en/3d-model/game/donner-falke)

Id objet : donner-falke
...
- epic volants SMI Sm-thunderhawks NONDL SUP


Description :

~~~
This is a proxy model of a Sci-Fi Gunship/Troop transport for tabletop gaming / diorama / collector 

Completed Model measures 

Length : 55cm 
Wingspan : 49cm
Height : 21 cm

I have test printed this model on a Phrozen Mini 8k. Every part fits the build dimension . Before people start asking if it can fit their printer. 

The largest part to print has the following dimension
 X: 136.13mm
Y: 68.22mm
Z: 147.07 mm

Please check the XYZ build size of your current Resin Printer.'

As for resin settings , I used the default resin settings for Phrozen Aqua Grey 8k at 50 micron layer on Chitubox

Build instructions, parts list , additional materials used are lsited in the Assembly manual 
