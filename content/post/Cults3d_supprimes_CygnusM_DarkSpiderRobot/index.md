...
---
title: "[BON-MARCHE] Cults3d_supprimes > CygnusM > DarkSpiderRobot [non dl]"
...
Source : [https://cults3d.com/en/3d-model/game/darkspiderrobot](https://cults3d.com/en/3d-model/game/darkspiderrobot)

Id objet : darkspiderrobot
...
~~~
There is some assembly involved if you wanna vary poses, each required part has a number you'll need to print four of numbers 6 and 9 and, two of 7 and 8. 
the multiple numbers are differnet versions, spiked and non spiked etc. 

the TurretMount is not requiered but just a simple add on if you wanna extend/raise the Head a bit.
