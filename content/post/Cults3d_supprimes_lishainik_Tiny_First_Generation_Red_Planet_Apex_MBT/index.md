...
---
title: "[PAYANT] Cults3d_supprimes > lishainik > Tiny_First_Generation_Red_Planet_Apex_MBT [non dl]"
date: "2023-12-09T22:46:38Z"
toc: true
image: "thumbs_-_tiny-first-generation-red-planet-apex-mbt_-_Images_1.jpg"
tags:
- "lishainik"
- "epic"
- "vehicules"
...
![](<thumbs_-_tiny-first-generation-red-planet-apex-mbt_-_Images_1.jpg> "thumbs_-_tiny-first-generation-red-planet-apex-mbt_-_Images_1.jpg")

  ![](<thumbs_-_tiny-first-generation-red-planet-apex-mbt_-_Makes_1.jpg> "thumbs_-_tiny-first-generation-red-planet-apex-mbt_-_Makes_1.jpg")

  

Source : [https://cults3d.com/en/3d-model/game/tiny-first-generation-red-planet-apex-mbt](https://cults3d.com/en/3d-model/game/tiny-first-generation-red-planet-apex-mbt)

Id objet : tiny-first-generation-red-planet-apex-mbt
...
~~~
This tiny MBT represents the finest produce of Red Planet's manufacturing plants. Perfect for games of tiny tanks or robots regardless of their place in the history of the future past.

This set contains 2 hull weapon options along with all available sponson weapons. In addition to that hull can be printed with extra protection for tracks. 
6 turret options are provided:
- Standart cannon
- 2 variants of extralong antitank cannon
- Advanced Energy Cannon
- dual automatic cannons
- Light Cannon "Conqueror"

Turrets accept 3x1 magnets and can be printed with hatches in open or closed postions (Tiny person furiously waving a sword is not included).
