...
Source : [https://cults3d.com/en/3d-model/game/space-elf-heavy-titan](https://cults3d.com/en/3d-model/game/space-elf-heavy-titan)

Id objet : space-elf-heavy-titan
...
- epic titans EN Eldars-tourmenteurs  NONSUP
...
~~~
Proof of concept for a Space Elf Heavy Titan that is meant to take on multiple other biggies.  The design is a more organic version of the standard space elf stuff.

This heavy is currently about 12" tall, but can be printed any size.
~~~
