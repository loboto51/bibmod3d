...
---
title: "[GRATUIT] Cults3d > Sneak_Attack > Instant_Power_Weapon_Bit [non dl]"
date: "2022-08-24T23:34:09Z"
toc: true
image: "thumbs_-_instant-power-weapon-bit_-_Images_1.avif"
tags:
- "Sneak_Attack"
- "28mm"
- "IMP"
...
![](<thumbs_-_instant-power-weapon-bit_-_Images_1.avif> "thumbs_-_instant-power-weapon-bit_-_Images_1.avif")

  

Source : [https://cults3d.com/en/3d-model/game/instant-power-weapon-bit](https://cults3d.com/en/3d-model/game/instant-power-weapon-bit)

Id objet : instant-power-weapon-bit
...
~~~
Have a cool looking melee weapon from some fantasy range that you want to use on a champion or special character? Wish that there was some easy way to make it more futuristic? Well (maybe) now there is!

Simple bit. Haven't printed this out on my own yet. Meant to sit flush against a piece of 2mm rod. Will most likely work better with pole mounted weapons than say, swords or blades. Let me know if any changes are needed. 

EDIT:
Forgot to mention that I utilized this cable bit from ROB_JEDI: >>>https://cults3d.com/en/3d-model/game/power-cable-greeblies
~~~
