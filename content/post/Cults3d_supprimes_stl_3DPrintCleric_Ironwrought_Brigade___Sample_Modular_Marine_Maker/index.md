...
---
title: "[GRATUIT] Cults3d_supprimes_stl > 3DPrintCleric > Ironwrought_Brigade___Sample_Modular_Marine_Maker [dl]"
date: "2022-06-29T07:38:32Z"
toc: true
image: "thumbs_-_ironwrought-brigade-sample-modular-marine-maker_-_Images_1.jpg"
tags:
- "3DPrintCleric"
- "15mm"
- "28mm"
...
![](<thumbs_-_ironwrought-brigade-sample-modular-marine-maker_-_Images_1.jpg> "thumbs_-_ironwrought-brigade-sample-modular-marine-maker_-_Images_1.jpg")

  ![](<thumbs_-_ironwrought-brigade-sample-modular-marine-maker_-_ImagesSTL_1.jpg> "thumbs_-_ironwrought-brigade-sample-modular-marine-maker_-_ImagesSTL_1.jpg")

  

Source : [https://cults3d.com/en/3d-model/game/ironwrought-brigade-sample-modular-marine-maker](https://cults3d.com/en/3d-model/game/ironwrought-brigade-sample-modular-marine-maker)

Id objet : ironwrought-brigade-sample-modular-marine-maker
...
~~~
The Ironwrought Brigade has been a line of models that have helped me grow as a 3D sculptor in so many ways. Creating models that could be modular and posed with many options or mixed with models from other manufacturers has been a treat.

This sample contains several parts from my Ironwrought Brigade line, with enough pieces to create a great many combinations. Please enjoy this same, and consider supporting us or otherwise enjoy the rest of our products.

Comes with the following:
- Boltgun (x1, with folded stock)
- Combat Knife (x1, held with reverse grip)
- Pistol (x1, with scope)
- Helmets (x2 options)
- Torso/Backpack (combined models, x2 options)
- Legs (x2 options)
- Arms (x1 paired option, x2 unpaired options)
- Shoulders (x3 options)
- Belt (x1)
- Premade model (x1)
~~~
