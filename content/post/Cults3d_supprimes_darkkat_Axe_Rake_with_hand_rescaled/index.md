...
---
title: "[GRATUIT] Cults3d_supprimes > darkkat > Axe_Rake_with_hand_rescaled [non dl]"
date: "2022-10-03T19:38:26Z"
toc: true
image: "thumbs_-_axe-rake-with-hand-rescaled_-_Images_1.jpg"
tags:
- "darkkat"
- "28mm"
- "IMP"
...
![](<thumbs_-_axe-rake-with-hand-rescaled_-_Images_1.jpg> "thumbs_-_axe-rake-with-hand-rescaled_-_Images_1.jpg")

  

Source : [https://cults3d.com/en/3d-model/game/axe-rake-with-hand-rescaled](https://cults3d.com/en/3d-model/game/axe-rake-with-hand-rescaled)

Id objet : axe-rake-with-hand-rescaled
...
~~~
Axe-rake from ForzeOfZeon (https://cults3d.com/en/3d-model/game/axe-rake) rescaled to fit my Ashen Circulus guys, also added a hand so you can print-and-glue-and-you-are-done!


Parts for complete flying burners:

- Heads (rescale to 90%) - (https://cults3d.com/en/3d-model/game/ashen-heads)
- Assault arms from LoggyK builder - (https://cults3d.com/en/3d-model/game/modular-marines-mk2-assault-bits-loggyk)
- Jumppacks from Mazer's kit - (https://cults3d.com/en/3d-model/game/assault-marine-builder-berserker-tzaangors-blade-cabal)
- Axe-rakes - originally by ForgesOfZeon (https://cults3d.com/en/3d-model/game/axe-rake), my rescaled version - (https://cults3d.com/en/3d-model/game/axe-rake-with-hand-rescaled)
- Weapons - (https://cults3d.com/en/3d-model/game/ashen-circle-flamer-and-melter)
- Torsos - (https://cults3d.com/en/3d-model/game/ashen-circle-torsos)
- Legs - (https://cults3d.com/en/3d-model/game/ashen-circle-legs)
- Shoulderpads - (https://cults3d.com/en/3d-model/game/ashen-circle-shoulderpad)
~~~
