...
---
title: "[GRATUIT] Cults3d_supprimes > JahnZizka > Epic_scale_corpses [non dl]"
date: "2021-03-31T00:26:18Z"
toc: true
image: "thumbs_-_epic-scale-corpses_-_Images_1.jpg"
tags:
- "JahnZizka"
- "epic"
- "infanterie"
...
![](<thumbs_-_epic-scale-corpses_-_Images_1.jpg> "thumbs_-_epic-scale-corpses_-_Images_1.jpg")

  

Source : [https://cults3d.com/en/3d-model/game/epic-scale-corpses](https://cults3d.com/en/3d-model/game/epic-scale-corpses)

Id objet : epic-scale-corpses
...
~~~
A bunch of corpses (or close enough to death) for Epic scale.
Reuploaded given Thingiverse inability to index properly.

Not to be printed as is (though it should be possible), place them over the terrain or
base before printing.
Ready to be printed without rotation (print from base to top).
The weird positioned ones are intended to be placed over trenches or walls.

This is a remix from:
Epic Slicin Scytherinos by BaseDepartment https://www.thingiverse.com/thing:4552873
6/8mm Empire Star Army, Acadian Infantry by Miffles_Makes https://www.thingiverse.com/thing:3746245

(Regarding the guard ones, I mainly made them printable without supports and added a small homage to an image art I personally love, kudos to its author)
...
Please note: Not test printed yet.
~~~
