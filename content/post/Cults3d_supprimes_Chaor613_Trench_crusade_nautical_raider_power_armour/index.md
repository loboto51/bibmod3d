...
![](<thumbs_-_trench-crusade-nautical-raider-power-armour_-_Images_1.avif> "thumbs_-_trench-crusade-nautical-raider-power-armour_-_Images_1.avif")

  ![](<thumbs_-_trench-crusade-nautical-raider-power-armour_-_Makes_1.avif> "thumbs_-_trench-crusade-nautical-raider-power-armour_-_Makes_1.avif")

  

Source : [https://cults3d.com/en/3d-model/game/trench-crusade-nautical-raider-power-armour](https://cults3d.com/en/3d-model/game/trench-crusade-nautical-raider-power-armour)

Id objet : trench-crusade-nautical-raider-power-armour
...
~~~
A speed model challenge to create some power armour inspired by a recent trench crusade image

Contains 3 monopose models, each with a unique loadout and pose
~~~
