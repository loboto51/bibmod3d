...
---
title: "[GRATUIT] Cults3d_supprimes_stl > Proveon > Space_Elf_Storm_soldiers [dl]"
...
Source : [https://cults3d.com/en/3d-model/game/space-elf-storm-soldiers](https://cults3d.com/en/3d-model/game/space-elf-storm-soldiers)

Id objet : space-elf-storm-soldiers
...
- epic infanterie VM Eldars-assaut  NONSUP


Description :

~~~
Only a lunatic would carry a sword on a modern battlefield. 
space elf melee experts is three poses, designed to be chunky for durability and fun. Set of 3 one piece models.
~~~
