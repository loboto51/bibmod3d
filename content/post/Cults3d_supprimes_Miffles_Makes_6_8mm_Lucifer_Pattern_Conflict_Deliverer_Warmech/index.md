...
---
title: "[PAYANT] Cults3d_supprimes > Miffles_Makes > 6_8mm_Lucifer_Pattern_Conflict_Deliverer_Warmech [non dl]"
...
Source : [https://cults3d.com/en/3d-model/game/6-8mm-lucifer-pattern-conflict-deliverer-warmech](https://cults3d.com/en/3d-model/game/6-8mm-lucifer-pattern-conflict-deliverer-warmech)

Id objet : 6-8mm-lucifer-pattern-conflict-deliverer-warmech
...
~~~
**This file only includes the outer armour plating only, you will require JimsBeanz Strife Herald for the core of the mech**

All armor plating and pattern specific components of this model are modeled from scratch in XSI Softimage.

The AT18Scale files are intended to fit JimsBeanz "Strife Herald Robot" parts have been tested and should fit well with minimal to no adjustment

Supplied at AT 8mm scale, for 28mm scale models scale up to 400%
