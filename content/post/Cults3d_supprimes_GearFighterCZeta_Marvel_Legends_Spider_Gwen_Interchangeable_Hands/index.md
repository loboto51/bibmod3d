...
---
title: "[GRATUIT] Cults3d_supprimes > GearFighterCZeta > Marvel_Legends_Spider_Gwen_Interchangeable_Hands [non dl]"
date: "2021-04-19T17:20:29Z"
toc: true
image: "thumbs_-_marvel-legends-spider-gwen-interchangeable-hands_-_Images_1.jpg"
tags:
- "GearFighterCZeta"
- "15mm"
- "28mm"
...
![](<thumbs_-_marvel-legends-spider-gwen-interchangeable-hands_-_Images_1.jpg> "thumbs_-_marvel-legends-spider-gwen-interchangeable-hands_-_Images_1.jpg")

  

Source : [https://cults3d.com/en/3d-model/art/marvel-legends-spider-gwen-interchangeable-hands](https://cults3d.com/en/3d-model/art/marvel-legends-spider-gwen-interchangeable-hands)

Id objet : marvel-legends-spider-gwen-interchangeable-hands
...
~~~
By downloading these files, you agree to not sell them.
If used, attribution is really appreciated.

WARNING:
Not recommended for small children: choking hazard.
The maker is not responsible for any untoward incident that might occur as a result of a misuse of the product.

Features:
2 pairs of open hands;
2 pairs of web shooting gesture hands;
2 pairs of pointing hands;
Fists;
OK gesture hands;
Gun gesture hands;
Victory gesture hands;
Hands for dynamic poses;

More: Coming soon.

INSTRUCTIONS:

The hands are designed so you can make your own pivot. Just slide, bend and twist a twist tie in the slit on the hand and harden the twisted part with superglue or scotch tape. This way you will get a pivot similar to the one used in marvel legends action figures and it could potentially fit almost every figure without any modification.
