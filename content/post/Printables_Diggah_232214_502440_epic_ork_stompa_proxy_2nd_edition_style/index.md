...
~~~
There are a number of Stompa proxies out there but none of them had that 2nd Edition vibe, so I designed my own. It's very similar to the original but not an exact copy. Many thanks to reddit user Marcus_Machiavelli for measurements from the original.

I'm quite likely to do some small variants of this model to keep things interesting so check back on this model for their inclusion.
