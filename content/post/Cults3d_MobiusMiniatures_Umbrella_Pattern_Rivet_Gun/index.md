...
---
title: "[GRATUIT] Cults3d > MobiusMiniatures > Umbrella_Pattern_Rivet_Gun [non dl]"
date: "2024-06-19T04:52:55Z"
toc: true
image: "thumbs_-_umbrella-pattern-rivet-gun_-_Images_1.jpg"
tags:
- "MobiusMiniatures"
- "28mm"
- "IMP"
...
![](<thumbs_-_umbrella-pattern-rivet-gun_-_Images_1.jpg> "thumbs_-_umbrella-pattern-rivet-gun_-_Images_1.jpg")

  

Source : [https://cults3d.com/en/3d-model/game/umbrella-pattern-rivet-gun](https://cults3d.com/en/3d-model/game/umbrella-pattern-rivet-gun)

Id objet : umbrella-pattern-rivet-gun
...
~~~
Decided I wanted some more "art accurate" Umbra for my Baddab Era Executioners. Includes the full gun, pistol gripless variant for compatibility with other miniatures, and magless versions  with separate empty mag. 

Somethings of note: These 'Rivet Guns' are a personal project and are scaled for Fummelfingers' True-Scale Marines, so they will most likely need to be rescaled to fit other, smaller minis. These are also a free product so if you have any criticisms, keep it to yourself. 
