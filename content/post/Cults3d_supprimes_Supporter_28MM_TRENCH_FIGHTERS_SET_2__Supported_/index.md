...
---
title: "[GRATUIT] Cults3d_supprimes > Supporter > 28MM_TRENCH_FIGHTERS_SET_2__Supported_ [non dl]"
date: "2020-07-15T14:37:54Z"
toc: true
image: "thumbs_-_28mm-trench-fighters-set-2-supported_-_Images_1.jpg"
tags:
- "Supporter"
- "28mm"
- "IMP"
...
![](<thumbs_-_28mm-trench-fighters-set-2-supported_-_Images_1.jpg> "thumbs_-_28mm-trench-fighters-set-2-supported_-_Images_1.jpg")

  ![](<thumbs_-_28mm-trench-fighters-set-2-supported_-_Makes_1.jpg> "thumbs_-_28mm-trench-fighters-set-2-supported_-_Makes_1.jpg")

  

Source : [https://cults3d.com/en/3d-model/game/28mm-trench-fighters-set-2-supported](https://cults3d.com/en/3d-model/game/28mm-trench-fighters-set-2-supported)

Id objet : 28mm-trench-fighters-set-2-supported
...
~~~
This is just a support file for Chitubox for the Legendary trench Fighter Set  2 by @KRACKENDOORSTUDIOS (https://cults3d.com/en/users/KrackendoorStudios/creations).
Original file can be found here
https://cults3d.com/en/3d-model/game/28mm-trench-fighters-set-2
I take no credit for the Minifigures, but as i was supporting it for print, i thought i will share it with you guys and gals.
Please feel free to download however do follow the original artist! his work is amazing!
If the artist decide to include my files in his release, those support files will be removed form my account.
No copyright infrigment is intended.
If you spot any islands (and considering the ammount of models in the file i may have missed one or two) do let me know which file and i will have it corrected.
Models have been extra supported with some medium supports, so that a full plate print can be done without failures :)
~~~
