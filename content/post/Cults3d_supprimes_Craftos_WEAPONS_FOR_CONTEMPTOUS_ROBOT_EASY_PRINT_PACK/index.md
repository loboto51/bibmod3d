...
---
title: "[GRATUIT] Cults3d_supprimes > Craftos > WEAPONS_FOR_CONTEMPTOUS_ROBOT_EASY_PRINT_PACK [non dl]"
date: "2021-11-30T22:00:32Z"
toc: true
image: "thumbs_-_weapons-for-contemptous-robot-easy-print-pack_-_Images_1.jpg"
tags:
- "Craftos"
- "epic"
- "chevaliers"
...
![](<thumbs_-_weapons-for-contemptous-robot-easy-print-pack_-_Images_1.jpg> "thumbs_-_weapons-for-contemptous-robot-easy-print-pack_-_Images_1.jpg")

  

Source : [https://cults3d.com/en/3d-model/game/weapons-for-contemptous-robot-easy-print-pack](https://cults3d.com/en/3d-model/game/weapons-for-contemptous-robot-easy-print-pack)

Id objet : weapons-for-contemptous-robot-easy-print-pack
...
~~~
The 9th season entire shooting weapons range (mounted in the arms) for the contemptous futuristic robot...

this is the combination of awesome work of LORDCHAMMON who compiled most of these weapons found within the universe for the Contemptor, i have just added a few extras that i have created to make the pack complete

**Now with the HHv2.0 Cyclone Launcher**

All the weapons are pre-supported and complete ready to print.

The Weapon mounts can use a 5mm x 1mm magnet for quick changes. comes with shoulder sockets aswell.

Weapons include:
Chaos Butcher Cannon
Volkite culverin 
Toxiferno Cannon 
Autocannon
C-Beam cannon
The arm joint is now magnet ready (5x1mm)
Heavy-bolter
...
Lordchammon - Compiling majority of the list
Sebtheis (kheres assault cannon, lascannon and butcher cannon)
PECET (c-beam, multi-melta and volkite)
CRAFTOS (plasma cannon, Cyclone Missile, Claw/powerfist)
Exerptus (toxin cannon)
~~~
