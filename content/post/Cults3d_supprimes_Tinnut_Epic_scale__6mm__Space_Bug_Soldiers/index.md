...
---
title: "[GRATUIT] Cults3d_supprimes > Tinnut > Epic_scale__6mm__Space_Bug_Soldiers [non dl]"
...
Source : [https://cults3d.com/en/3d-model/game/epic-scale-6mm-space-bug-soldiers](https://cults3d.com/en/3d-model/game/epic-scale-6mm-space-bug-soldiers)

Id objet : epic-scale-6mm-space-bug-soldiers
...
~~~
Eight space bug soldier proxies at an Epic (6mm) scale.  I've been able to print them on my Ender 3 using a 0.25mm nozzle, but wow getting the supports off is a nightmare.

They might be a tad bigger than they should be.

They're very exaggerated as they're just meant for epic scale.
~~~
