...
---
title: "[PAYANT] Cults3d_supprimes > BitsBlitzDesigns > Smallscale_Weapon_Morphing_Infantry [non dl]"
...
~~~
Designed for 6mm/8mm gaming in mind. Compatible with games such as Epic or Adeptus Titanicus.

This kit contains the following miniatures:
- 10 Weapon Morphing Infantry (with 6mm inserts)
- 10 Weapon Morphing Infantry (without 6mm inserts)

**NOTE: 25mm round bases on picture not included in this set, they are [available separately](https://cults3d.com/en/3d-model/game/25mm-round-bases-for-6mm-8mm-miniatures-tech-shanty-texture) though! Same goes for the [close combat brute](https://cults3d.com/en/3d-model/game/smallscale-close-combat-brutes).**
