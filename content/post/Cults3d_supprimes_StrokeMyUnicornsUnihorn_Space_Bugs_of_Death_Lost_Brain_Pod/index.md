...
---
title: "[GRATUIT] Cults3d_supprimes > StrokeMyUnicornsUnihorn > Space_Bugs_of_Death_Lost_Brain_Pod [non dl]"
...
Source : [https://cults3d.com/en/3d-model/game/space-bugs-of-death-lost-brain-pod](https://cults3d.com/en/3d-model/game/space-bugs-of-death-lost-brain-pod)

Id objet : space-bugs-of-death-lost-brain-pod
...
~~~
This .stl library is a space bug of death lost brain pod original model kit and needs to be printed on an SLA printer.

.STL library to create lost brain pod space bug. The model fits on a 25mm base (included, check out my base pack). 

Get the big boy version here https://cults3d.com/en/3d-model/game/space-bugs-of-death-migraine-hive-lord

Update 18/6/2023 - Pre-supports
- added pre-supports for all parts

Update 21/6/2023 - Silly hat pose
- added new pose with hat
