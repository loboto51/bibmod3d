...
---
title: "[GRATUIT] Cults3d_supprimes_stl > dreadpiratelynx > Tiny_Marine_Snake_Lady_Tank [dl]"
...
Source : [https://cults3d.com/en/3d-model/game/tiny-marine-snake-lady-tank](https://cults3d.com/en/3d-model/game/tiny-marine-snake-lady-tank)

Id objet : tiny-marine-snake-lady-tank
...
~~~
6 small scale Legion Medusae for use in 30K era Epic or AT. Includes two siege gun variants each mounted at three different angles for variety. The gun variants can be used to visually distinguish Medusa with/without phosphex rounds if desired.

Remixed from:
Hull: [Tiny Tank Classic Artillery] (https://cults3d.com/en/3d-model/game/tiny-tank-classic-artillery) by [Woddish] (https://cults3d.com/en/users/woddish/creations)
Medusa Siege Gun: [Epic Scaled Self-Propelled Artillery] (https://cults3d.com/en/3d-model/game/epic-scale-self-propelled-artillery) by [Mkhand_Industries] (https://cults3d.com/en/users/Mkhand_Industries/creations)
~~~
