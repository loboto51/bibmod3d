...
---
title: "[PAYANT] Cults3d_supprimes > CMDRZhor > RV_A_Zhor_pattern_Heavy_Gatling_Cannon [non dl]"
date: "2022-04-18T10:41:00Z"
toc: true
image: "thumbs_-_rv-a-zhor-pattern-heavy-gatling-cannon_-_Images_1.jpg"
tags:
- "CMDRZhor"
- "epic"
- "titans"
...
![](<thumbs_-_rv-a-zhor-pattern-heavy-gatling-cannon_-_Images_1.jpg> "thumbs_-_rv-a-zhor-pattern-heavy-gatling-cannon_-_Images_1.jpg")

  

Source : [https://cults3d.com/en/3d-model/game/rv-a-zhor-pattern-heavy-gatling-cannon](https://cults3d.com/en/3d-model/game/rv-a-zhor-pattern-heavy-gatling-cannon)

Id objet : rv-a-zhor-pattern-heavy-gatling-cannon
...
~~~
This is a heavy gatling cannon arm weapon for huge battle robots. The elbow joint has a well for a 5mm magnet in it, along with interface ports to make it compatible with the WB series of slightly-bigger-than-huge battle robots. It can be used as either the left or right arm with no modifications.

It comes in two pieces, the gun itself and the barrel assembly, so you can use a barrel design of your choice if you so wish.
